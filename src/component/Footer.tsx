        ...
        <div>
            <footer className="footer sm:footer-horizontal bg-base-100 text-base-content container mx-auto w-full p-10 flex flex-col justify-center my-10">
                <div className='flex  flex-col md:flex-row justify-between mx-auto w-full'>
                    <aside className='flex flex-col gap-6 text-center md:text-start'>
                        <img className='w-35 mx-auto md:mx-0' src={logo} alt="" />
                        <p className='text-gray-500'>
                            Curated tools, technologies, and resources for developers building
                           modern software.
                        </p>
                        <div className=' text-gray-500 flex gap-2 justify-between md:mx-0 mx-auto w-[70%] md:w-0'>
                            <a href="">GitHub</a>
                            <a href="">Twitter</a>
                            <a href="">LinkedIn</a>
                        </div>
                    </aside>
                    <div className='hidden md:flex flex-col md:flex-row mx-auto justify-around w-[70%] text-center md:text-start'>
